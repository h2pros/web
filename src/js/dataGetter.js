...
function getColdData(timeScale){
  if(timeScale == 'day'){
    ...
    return [
      ['66.5', '58.0', '56.0', '58.5', '44.5', '45.0', '63.5', '65.5', '60.0', '56.5', '78.5', '82.0', '54.5', '67.5', '63.5', '68.0', '71.5', '59.0', '68.0', '84.0'],
      ['70.0', '75.0', '83.0', '65.0', '71.0', '82.5', '85.0', '71.5', '68.0', '79.5', '76.0', '90.0', '88.0', '40.0', '77.0', '90.0', '71.5', '76.0', '78.0', '75.0']
    ]
  }
}
...
function getHotData(timeScale){
  if(timeScale == 'day'){
    ...
    return [
      ['71.5', '62.5', '66.5', '50.5', '57.0', '70.5', '64.5', '72.5', '69.5', '65.5', '70.0', '63.0', '53.0', '60.5', '63.5', '72.0', '69.0', '47.5', '71.5', '64.5'],
      ['68.0', '72.5', '81.0', '90.0', '92.0', '72.5', '87.0', '83.5', '71.5', '70.0', '67.0', '77.5', '81.5', '50.5', '84.5', '85.0', '78.5', '83.5', '78.0', '73.5']
    ]
